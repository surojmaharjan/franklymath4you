...
class Questions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_register', 'numerical', 'integerOnly'=>true),
			array('course, attach_file', 'length', 'max'=>225),
			array('question', 'safe'),
               array('attach_file', 'file', 'types'=>'jpg, png, jpge, pdf', 'allowEmpty'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, course, question, attach_file, is_register', 'safe', 'on'=>'search'),
		);
	}
