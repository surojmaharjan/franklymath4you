                  ...
                  <div class="form-container-wrapper">
                     <div class="form-container">
                        ...
                        if (isset($success_msg1)) {
                           echo '<p class="success">' . $success_msg1 . '</p>';
                        }
                        else if (isset($fail_msg1)) {
                           echo '<p class="error_msg">' . $fail_msg1 . '</p>';
                        }
                        ...
                        if (isset($success_msg2)) {
                           echo '<p class="success">' . $success_msg2 . '</p>';
                        }
                        else if (isset($fail_msg2)) {
                           echo '<p class="error_msg">' . $fail_msg2 . '</p>';
                        }
